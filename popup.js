...
// Convert HTML to Markdown via Turndown (runs in popup/preview context, not content script)
function htmlToMarkdown(html) {
  ...
  if (jinaMdBtn) {
    ...
    jinaMdBtn.addEventListener("click", async () => {
      ...
      // For Local mode: convert HTML→Markdown in popup context (not content script)
