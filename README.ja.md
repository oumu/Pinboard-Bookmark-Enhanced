...
[Pinboard](https://pinboard.in) のための Chrome 拡張機能。AI タグと要約、翻訳・ハイライト付きの内蔵リーダー、そして pinboard.in 用テーマ 13 種を備えています。
...
- **読みながら単語を調べて復習**：オンライン辞書のほか、中国語から英語・英語から中国語の両方向のオフライン辞書パックを追加でき、単語帳に保存した語を検索・並べ替え・グループ分けできます。現在の Pinboard アカウントの全項目をエクスポートまたは Anki に送信し、対応する単語は Eudic に送信できます
